	...
	<div class="grid-x grid-padding-x">
	    ...
	    <div class="small-9 cell">
	       <div class="input-group">
			  ...
			  <input class="input-group-field" id="middle-label" type="text" name="contact_name" value="{{$customer['lead']['contact_name']}}">
			</div>
	    </div>
	    ...
	    <div class="small-9 cell">
	       <div class="input-group">
			  ...
			  <input class="input-group-field" id="middle-label" type="number" name="contact_phone" value="{{$customer['lead']['contact_phone']}}">
			</div>
	    </div>
	    ...
	    <div class="small-9 cell">
	       <div class="input-group">
			  ...
			  <input class="input-group-field" id="middle-label" type="email" name="contact_email" value="{{$customer['lead']['contact_email']}}">
			</div>
	    </div>
	    ...
	    <div class="small-9 cell">
	       <div class="input-group">
			  <input class="input-group-field" id="middle-label" type="text" name="contact_designation" value="{{$customer['lead']['contact_designation']}}">
			</div>
	    </div>
